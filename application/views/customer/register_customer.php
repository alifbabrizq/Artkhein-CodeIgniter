	...
	<div class="wrapper">
		<div class="inner">
			<div class="image-holder">
				<img style="width:285px; height:520px;" src="<?php echo base_url();?>assets/register/images/cus1.png"
					alt="">
			</div>
			<!-- <?php
			...
			?> -->
			<form action="<?php echo base_url();?>index.php/Login/create_customer" method="post"
				enctype="multipart/form-data">
				<h2
					style="font-family: Rubik; font-style: normal; font-weight: bold; font-size: 50px; line-height: 107px; color: #6E0EBA; text-shadow: 3px 4px 6px rgba(0, 0, 0, 0.25);margin-top:-62px;">
					CREATE</h2>
				<h2
				...
				<input style="width:100%; margin-bottom:20px;" type="text" class="form-control" name="nama_costumer"
					placeholder="Nama">
				<div class="form-row">
				...
				<input style="width:100%; margin-bottom:20px;" type="number" class="form-control" name="no_rek"
					placeholder="No rekening">
				<textarea placeholder="Alamat" name="alamat_costumer" class="form-control"
					style="height: 100px;"></textarea>
				<input class="button" style="width:100%;" type="submit" name="submit" value="SIGN UP AS CLIENT">
			</form>
